...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'git-blame.nvim', 'gitsigns.nvim', 'diffview.nvim', 'indent-blankline.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
