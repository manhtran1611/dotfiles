...
nnoremap <silent> <S-q> :<C-U>bprevious <bar> bdelete #<CR>
...
" Clear highlighting
if maparg('<C-L>', 'n') ==# ''
  nnoremap <silent> <leader>n :<C-U>nohlsearch<C-R>=has('diff')?'<Bar>diffupdate':''<CR><CR><C-L>
endif
...
nnoremap <silent> <S-l> :<C-U>call buf_utils#GoToBuffer(v:count, 'forward')<CR>
nnoremap <silent> <S-h> :<C-U>call buf_utils#GoToBuffer(v:count, 'backward')<CR>
